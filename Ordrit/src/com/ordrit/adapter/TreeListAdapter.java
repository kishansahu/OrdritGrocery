...
import com.ordrit.R;
import com.ordrit.treeview.AbstractTreeViewAdapter;
import com.ordrit.treeview.TreeNodeInfo;
 ...
 * 
 */
public class TreeListAdapter extends AbstractTreeViewAdapter<Long> {
  ...
  /*  private final OnCheckedChangeListener onCheckedChange = new OnCheckedChangeListener() {
    ...
    public TreeListAdapter(final Activity treeViewListDemo,
    ...
    private String getDescription(final long id) {
        ...
        return "Item " + id + Arrays.asList(hierarchy);
    }
